      ...
      <div className='about_content'>
        ...
        <div className='about_data'>
          ...
          <div className='about_intro'>
            <p>
              Hi! My name is <span className="">Disha Doshi </span>, a 22-year-old Software Developer living in Pune, India. I have a Bachelors’s Degree in Computer Science from the Savitribai Phule Pune University. Currently, I work as a full-time software Engineer at a <span className="imp-effect">E-zest Solutions LTD.</span>
            </p>
